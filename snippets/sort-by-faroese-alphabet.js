...
const letters = ['Arnsvein', 'Adriel', 'Sigbjartur', 'Signhard', 'Heðin', 'Gullbrandur', 'Aleks', 'Poul', 'Hildibjørn', 'Augustinus'];

const lettersSorted = letters.sort((a, b) => {
